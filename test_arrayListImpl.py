...
class TestArrayListImpl(TestCase):
    ...
    def array_instance_generator(self, size: Optional[int] = None) -> ArrayListImpl:
    ...
    def test04_size_0(self):
        test_array_0 = self.array_instance_generator()
        test_array_5 = self.array_instance_generator(5)
    ...
    def test09_remove_return(self):
        test_array_0 = self.array_instance_generator(5)
        test_array_1 = self.array_instance_generator(5)
    ...
    def test11_remove_none(self):
        test_array = self.array_instance_generator(4)
